    ...
    return (
        ...
        {loading ? (
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                {/* Боковые карточки */}
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-1 gap-4 w-full lg:w-1/3">
                    {movies.slice(1, 4).map((movie) => (
                        <Card
                            key={movie.id}
                            className="relative group flex w-full h-50 lg:h-full rounded-lg overflow-hidden bg-transparent border-none p-0"
                        >
