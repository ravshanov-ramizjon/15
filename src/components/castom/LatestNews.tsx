        ...
        <div className="mb-12">
            ...
            {loading ? (
                <div className="flex flex-col md:flex-row gap-6">
                    <Skeleton className="w-full md:w-2/3 h-[300px] md:h-[400px] rounded-xl" />
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    {/* Главная новость */}
                    <div className="relative w-full lg:w-2/2 h-[400px] md:h-[500px] rounded-xl overflow-hidden">
                        <Image
                ...
                {/* Боковые карточки */}
<div className="flex h-auto lg:h-125 flex-col gap-4 w-full lg:w-1/3">
  {movies.slice(1, 4).map((movie, index) => (
    <Card
      key={movie.id}
      className="relative group flex w-full h-full rounded-lg overflow-hidden bg-transparent border-none p-0"
    >
      <div className="relative w-full h-full">
        <Image
          ...
          alt={movie.title}
        fill
          className="object-cover transition duration-300 group-hover:brightness-75 group-hover:saturate-150 group-hover:sepia-[0.3] group-hover:hue-rotate-30"
        />
      ...
      <div className="absolute bottom-2 left-3 right-3 flex flex-col justify-end">
        ...
        <Button
          variant="outline"
          className=" absolute top-15 left-15 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 mt-2 border-white text-white w-fit h-7 text-xs"
          >
          Читать новость
        </Button>
    </Card>
